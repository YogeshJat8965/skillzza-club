// ALL CONTENT FROM SKILLZZA club.pdf — No other content allowed
...
export const challenge = {
  ...
  stats: [
    ...
    { title: "Low Measurable Skill Tracking", value: 68, color: "#EAB308" },
    { title: "Minimal Real-World Application Exposure", value: 81, color: "#F97316" },
    { title: "High Demand for Future Skills Integration", value: 94, color: "#10B981" },
  ],
};
...
export const studioModel = {
  ...
  cta1: "Design Your Studio Mix",
  cta2: "Schedule Discovery Session",
};
...
export const domainsSection = {
  ...
  domains: [
    ...
    { emoji: "🚀", name: "Space Sciences & Innovation" },
  ],
};
...
export const footer = {
  ...
  office: {
    label: "India Office",
    address:
      "WeWork India, Chromium, CTS No. 106/1-5, JPLR Road, Milind Nagar, Powai, Mumbai – 400076.",
  },
  presence: {
    label: "Our Presence",
    cities: ["Mumbai", "Thane", "Raipur", "Delhi NCR", "UK", "UAE"],
  },
  contact: {
    label: "Contact Us",
    phone: "+91 9136961978",
